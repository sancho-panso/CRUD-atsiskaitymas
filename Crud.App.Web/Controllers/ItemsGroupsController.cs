...
namespace Crud.App.Web.Controllers
{
    public class ItemsGroupsController : Controller
    {
        ...
        {
            var context = _context.ItemsGroups.Include(i => i.ParentItemsGroup);
        ...
        {
            ViewData["ParentItemsGroupID"] = new SelectList(_context.ItemsGroups, "ItemsGroupID", "ItemsGroupCode");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ItemsGroupID,ItemsGroupCode,ItemsGroupName,ItemsGroupNameEN,ItemsGroupNameRU,ParentItemsGroupID")] ItemsGroup itemsGroup)
        {
